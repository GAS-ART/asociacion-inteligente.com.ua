   ...
   <div class="concert__container">
      <div class="concert__body">
         ...
         <div class="concert__item item-concert-description">
            <h1 class="item-concert-description__title">@lang('ponomariov.charity_diner.title')</h1>
            <div class="item-concert-description__text">@lang('ponomariov.text')</div>
            <div class="item-concert-description__time">@lang('ponomariov.charity_diner.time')</div>
            <div class="item-concert-description__place">@lang('ponomariov.place')</div>
            <div class="item-concert-description__price">@lang('ponomariov.charity_diner.price')</div>
            <div class="item-concert-description__ways-pay concert-ways-pay">
               ...
               <div class="concert-ways-pay__way-pay">
                  <div data-link="https://buy.stripe.com/fZeaFY2QFbxMd1ufZ3" data-pay="stripe"
                  ...
                  <div data-link="active" data-pay="paypal" class="concert-ways-pay__paypal paypal _payment-method">
            ...
            <div class="item-concert-description__link"><a target="_blank"
                  ...
                  <form class="paypal-btn" action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post"
                     target="_blank">
                     <input type="hidden" name="cmd" value="_s-xclick">
                     <input type="hidden" name="hosted_button_id" value="WRKVZJDYP3NWL">
                     <input class="paypal-img" type="image"
                        src="https://www.sandbox.paypal.com/en_US/i/btn/btn_buynow_SM.gif" border="0" name="submit"
